...
(function(window, factory) {
    ...
    if (typeof define == "function" && define.amd) {
        ...
        window.Outlayer.Item = factory(
            window.EvEmitter, window.getSize);
    }
...
(function(window, factory) {
    ...
    if (typeof define == "function" && define.amd) {
        ...
        window.Outlayer = factory(
            window, window.EvEmitter, window.getSize, window.fizzyUIUtils, window.Outlayer.Item);
    }
...
(function(window, factory) {
    ...
    if (typeof define == 'function' && define.amd) {
        ...
        // CommonJS
        module.exports = factory(
            window, require('outlayer'), require('get-size'), require('desandro-matches-selector'), require('fizzy-ui-utils'), require('isotope/js/item'), require('isotope/js/layout-mode'),
            // include default layout modes
